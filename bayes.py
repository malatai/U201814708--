...
def test_bayes():
    ...
    for i in list(range(len(test_mat))):
        ...
        if test_classes[i] == 1:
            b_correct_count = b_correct_count + result
            b_count +=1
        else:
            g_correct_count = g_correct_count + 1 -result
            g_count += 1
    print(b_correct_count / b_count)
    print(g_correct_count / g_count)
